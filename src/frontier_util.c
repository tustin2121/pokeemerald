...
static void AppendIfValid(u16 species, u16 heldItem, s16 hp, u8 lvlMode, u8 monLevel, u16 *speciesArray, u16 *itemsArray, u8 *count)
{
    s32 i = 0;
...
static void sub_81A3FD4(void)
{
    ...
    do
    {
        ...
        do
        {
            ...
            s16 hp = GetMonData(&gPlayerParty[monId], MON_DATA_HP);
